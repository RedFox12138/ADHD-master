...
# 读取EEG数据
with open('D:\\Pycharm_Projects\\ADHD-master\\data\\额头信号去眼电\\0522 XY 小程序1_processed.txt', 'r') as f:
...
#         beta_band = [13, 30]
#         # 计算当前窗口的TBR
#         tbr = compute_power_ratio(window_signal, fs, theta_band, beta_band, False)
#
#         # 记录结果
...
#     # 参数设置
#     file_path = 'D:\\Pycharm_Projects\\ADHD-master\\data\\额头信号去眼电\\0522 XY 小程序2_processed.txt'
#     sampling_freq = 250
#
#     # 计算时序TBR (6s窗长，0.5s步长)
...
#     plt.title('Time-varying Theta/Beta Ratio (6s window, 0.5s step)')
#     plt.grid(True)
#     plt.legend()
#     plt.show()